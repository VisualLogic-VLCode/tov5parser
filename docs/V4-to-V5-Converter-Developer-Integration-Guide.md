...
| 模块格式 | ES Module |
| 许可证状态 | `UNLICENSED` |
| Release | <https://github.com/VisualLogic-VLCode/tov5parser/releases/tag/v1.2.8> |
| Release 包 | <https://github.com/VisualLogic-VLCode/tov5parser/releases/download/v1.2.8/tov5parser-1.2.8.tgz> |
| Release 包 SHA-256 | `100e1b59a30758b3abd8d5bffbea0e840f5383c03456e2d799efd43644bdd611` |
...
npm install --save-exact \
  https://github.com/VisualLogic-VLCode/tov5parser/releases/download/v1.2.8/tov5parser-1.2.8.tgz
```
